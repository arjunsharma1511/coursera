...
<div class="container-fluid d-flex flex-column p-0">
  <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
    ...
    <img src="../assets/icon/android-chrome-192x192.png" style="height: 60px">
    </div>
    <div class="sidebar-brand-text mx-3"><span>Webex</span></div>
  </a>
  ...
  -->  <li class="nav-item"><a class="nav-link nav-profile" href="profile.html"><i class="fas fa-user"></i><span>Profile</span></a></li>
    ...
    <li class="nav-item"><a class="nav-link nav-schedule" href="exam.html"><i class="fas fa-table"></i><span>Exam</span></a></li>
